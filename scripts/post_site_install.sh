...
wget -P /srv/aegir/platforms/$1/sites/$1/files/images/user-pics/ https://raw.github.com/pearance/pro_101_install_profile/master/imports/picture-default.png
...
/srv/aegir/bin/drush -y @$1 fr pro_101_wrap
